...
def test_serverless_version(mocker):
    mocker.patch('bentoml.utils.whichcraft.which', return_value='test')
    print(bentoml.utils.whichcraft.which)
    mocker.patch(
...
# def test_deploy_serverless(mocker, bento_archive_path):
